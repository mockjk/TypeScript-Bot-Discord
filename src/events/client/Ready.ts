...
export default class Ready extends Event {
    ...
    async Execute(){
        ...
        if(!this.client.developmentMode){
            ...
            console.log(`Sucessfuly loaded ${globalCommands.length} global application (/) commands`);
        };
        ...
        console.log(`Sucessfuly loaded ${devCommands.length} developer application (/) commands`);
    };
